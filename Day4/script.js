...
//   console.log(namesArray)
  ...
  const sortedArray = inventors.sort((inventor1,inventor2)=>inventor1.year-inventor2.year)
...
//   console.log("Total Years: " ,totalYears)
  ...
  // 5. Sort the inventors by years lived
    const sortedArrayByYearsLived = inventors.sort((a1,a2)=>(a1.passed-a1.year-a2.passed+a2.year))
    console.table(sortedArrayByYearsLived)
  ...
  // Sort the people alphabetically by last name
    const sortPeople = people.sort((a1,a2)=>{
        a1=a1.split(',')[1]
        a2=a2.split(',')[1]
        return a1>a2 ? 1 : -1
    })
